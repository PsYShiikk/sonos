...
@section('contenu')
    ...
    <div class="preview_profile">
        ...
        <a href="/utilisateur/{{Auth::user()->id}}" class="pic">
            <img src="{{Auth::user()->avatar}}" alt="photo de {{ Auth::user()->username }}">
        </a>
        <a href="/utilisateur/{{Auth::user()->id}}" class="profil_name_home" >
            <span >{{Auth::user()->forename}} {{Auth::user()->lastname}}</span>
        </a>

        <a href="/utilisateur/{{Auth::user()->id}}" class="profil_username_home">
